...
def run_analysis():
    """
    Executes a post-scan latency isolation routine.
    Differentiates authentic MySQL thread delays from generic network jitter/congestion.
    """
