...
if [ "$risk_mode" = "true" ]; then
    echo ""
    echo -e "\e[0;33m[\e[0m!\e[0;33m]\e[0m MODE RISK AKTIF: Mengirimkan Stacked Requests via Tor SOCKS5..."
    echo ""
    sleep 3

    risk_file_01="$target_url//.env%00"
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_01 ( Mode RISK )"
    ...
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_02 ( Mode RISK )"
    ...
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_03 ( Mode RISK )"
    ...
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_04 ( Mode RISK )"
...
risk_file_06="$target_url/.env.bak"
    ...
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_08 ( Mode RISK )"
    ...
    echo -e "\e[0;33m[\e[0m!\e[0;34m+]\e[0m Memindai $risk_file_09 ( Mode RISK )"
